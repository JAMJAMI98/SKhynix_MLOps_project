<div align="center">
  ...
  <p align="center">
    <a href="https://github.com/JAMJAMI98">현재민</a> · 이승규 · <a href="https://github.com/sjp84">박소정</a> · 정대훈
  </p>
  <p align="center">
...
### 3. 지속 가능한 생산활동과 ESG 경영 추구
- DBL Impact 기반의 의사결정 방법론과 예측 모델을 결합하여 지속 가능한 생산활동을 지원하고 ESG 경영 추구
- 생산 효율성을 높이고 환경적 영향을 최소화하며, 기업의 경제적 이윤 창출을 동시에 달성
- 2기 프로젝트에서 수집된 **DBL Impact 기반의 수요정보**와 본 프로젝트의 **예측 모델 개발을 Integration**하여, 데이터의 일관성을 유지하며 예측 모델을 더욱 정교하고 신뢰성 있게 작동할 뿐만 아니라 최적화 운영 방안 마련 가능 
